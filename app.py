...
def compute_stats(data, lookback):
    ...
    mdd_hist = mdd_day
    return [sharpe, winrate, profit_factor, ann, downside, var95, cvar95, mdd_day, mdd_look, mdd_hist], profit_factor, ann, downside, var95, cvar95, mdd_day, mdd_look, mdd_hist]
